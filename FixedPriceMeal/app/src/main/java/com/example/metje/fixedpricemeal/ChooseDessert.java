...
public class ChooseDessert extends AppCompatActivity
{
	private ArrayList<ImageModel> imageModelList;
	private int[] imageList = new int[]{
			R.drawable.clafoutis, R.drawable.millefeuille,
			R.drawable.kouignamann
	};
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_choose_dessert);

		imageModelList = populateList();
		ListView listView = (ListView) findViewById(R.id.desListView);
...
//				Toast.makeText(getApplicationContext(), "you have chosen: " + text, Toast.LENGTH_SHORT).show();
	...
	private ArrayList<ImageModel> populateList()
	{
		...
		String[] appetizerOptions = getResources().getStringArray(R.array.dessert_choices);
